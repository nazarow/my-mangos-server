...
void OutdoorPvPObjectiveTF::FillInitialWorldStates(WorldPacket &data, uint32 &count)
{
    FillInitialWorldState(data, count, TFTowerWorldStates[m_TowerType].n, (m_TowerState & TF_TOWERSTATE_N));
    FillInitialWorldState(data, count, TFTowerWorldStates[m_TowerType].h, (m_TowerState & TF_TOWERSTATE_H));
    FillInitialWorldState(data, count, TFTowerWorldStates[m_TowerType].a, (m_TowerState & TF_TOWERSTATE_A));
}
