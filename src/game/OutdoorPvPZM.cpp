...
void OutdoorPvPObjectiveZM_Beacon::FillInitialWorldStates(WorldPacket &data, uint32 &count)
{
...
void OutdoorPvPObjectiveZM_GraveYard::FillInitialWorldStates(WorldPacket &data, uint32 &count)
{
