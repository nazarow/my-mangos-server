...
const creature_type ZM_HordeFieldScout = {18564,HORDE,530,296.625f,7818.4f,42.6294f,5.18363f};
// alliance field scout spawn data
const creature_type ZM_AllianceFieldScout = {18581,ALLIANCE,530,374.395f,6230.08f,22.8351f,0.593412f};
