...
void OutdoorPvPMgr::ToggleOutdoorPvPTesting()
{
    m_OutdoorPvPTesting = !m_OutdoorPvPTesting;
    if(m_OutdoorPvPTesting)
        sWorld.SendGlobalText("OutdooPvP are set faster.", NULL);
    else
        sWorld.SendGlobalText("OutdoorPvP are set to normal.", NULL);
}